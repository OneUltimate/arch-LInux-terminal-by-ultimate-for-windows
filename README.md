...
prealpha-v0.7 (19.08.2025): Добавлена начальная заставка, новые команды, поддержка telegram - бота переехал в отдельный плагин [telegramlplus](plugins.telegrambotplus_plugin.py), level up security, hotfix
