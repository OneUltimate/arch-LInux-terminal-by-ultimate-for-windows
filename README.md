...
## *ru* 
Терминал (интерпритатор) в стиле Arch Linux для Windows с мониторингом показателей и интегрированным Telegram-ботом
...
prealpha-v0.7 (19.08.2025): Добавлена начальная заставка, hotfix
